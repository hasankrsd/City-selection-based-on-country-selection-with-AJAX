...
--
-- Anamakine: localhost
-- Üretim Zamanı: 12 Ağu 2021, 11:43:50
...
CREATE TABLE `citys` (
  ...
  `cityName` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
INSERT INTO `citys` (`cityId`, `cityName`, `countryId`) VALUES
(4077, '\'Adan', 243),
(1977, '\'Ajlun', 111),
(964, '\'Ali Sabih', 59),
(110, '\'Ayn Daflah', 3),
...
ALTER TABLE `citys`
  ...
  ADD KEY `baslik_ulke_id` (`cityName`,`countryId`);
...
--
ALTER TABLE `citys`
  MODIFY `cityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4202;
COMMIT;
